...
export const siteConfig: SiteConfig = {
	title: "素鱼",
	subtitle: "一个简单的博客",
	siteURL: "https://www.suyukk.xyz/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/suyu318",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/358547745?spm_id_from=333.1387.0.0",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://poetic-zuccutto-540235.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
